...
public class Student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Father Mobile Number");
        ...
        jComboBox1.setFont(new java.awt.Font("Tahoma", 1, 21)); // NOI18N
          ...
          String Section=jTextField3.getText();
           String RollNo=jTextField4.getText();
            String Gender=(String)jComboBox1.getSelectedItem();
             String FMobNo=jTextField5.getText();
             try{
                 ...
                 ps.setString(6,FMobNo);
                 ps.executeUpdate();
                 setVisible(false);
                 new instructions(RollNo).setVisible(true);
